# Adapted from:
# https://github.com/kjunelee/MetaOptNet/blob/master/data/CIFAR_FS.py
...
def get_pickle_paths():
    return dict(
        ...
        file_train_categories_train_base_phase = os.path.join(
            _CIFAR_FS_DATASET_DIR,
            'CIFAR_FS_train_base.pickle'),
        file_train_categories_train_base2_phase = os.path.join(
            _CIFAR_FS_DATASET_DIR,
            'CIFAR_FS_train_base2.pickle'),
...
class CIFAR_FS(data.Dataset):
    ...
    def __init__(self, phase='train', do_not_use_random_transf=False, force_use_random_transf=False, get_pickle_paths=None):
        ...
        if (not force_use_random_transf) and ((self.phase=='test' or self.phase=='val' or self.phase.startswith('val_base')) or (do_not_use_random_transf==True)):
